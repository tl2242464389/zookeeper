...
public class ZooKeeperWatcher implements Watcher {
	...
	/** zookeeper服务器地址 */
	private static final String CONNECTION_ADDR = "192.168.76.133:2181,192.168.76.134:2181,192.168.76.135:2181";
	/** zk父路径设置 */
	...
	public void process(WatchedEvent event) {
		...
		if (KeeperState.SyncConnected == keeperState) {
			...
			//删除节点
				...
				System.out.println("无法识别的EventType");
			}
		} 
			...
			System.out.println("与ZK连接处于未知状态");
		}
